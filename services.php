                ...
                <div class="wants-wrapper w-padding2">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-5">
                            <a href="#" class="btn wantToWork-btn"><img src="img/icon/call2.png" alt=""> Learn More</a>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-xl-12 ">
                            ...
                            <div class="testmonial-item-active text-center">
                                ...
                                <div class="testmonial-item ">
                                    <p class="pera">They Keep me fresh always</p>
                                    <div class="rating">
                                ...
                                <!-- testimonial-single-items -->
                                <div class="testmonial-item ">
                                    <p class="pera">Very Very Kamaful</p>
                                    <div class="rating">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                ...
                <div class="single-footer-caption mb-50">
                    <div class="footer-tittle">
                        ...
                        <ul>
                            ...
                            <li><a href="#">- Laundry Service Ghana</a></li>
                            <li><a href="#">- Track your laundry</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                <div class="single-footer-caption mb-50">
                    <div class="footer-tittle">
                        <h4>Get in touch</h4>
                        <ul>
                            <li class="number"><a href="#"> +233 242 2192</a></li>
                            <li><a href="#">bubbles@gmail.com</a></li>
                            <li><a href="#">1 University Avenue</a></li>
                        </ul>
                    </div>
                </div>
            </div>
