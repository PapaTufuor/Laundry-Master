...
<head>
    ...
    <title>Bubbles Laundromat</title>
    ...
    <!-- CSS here -->
    <link rel="stylesheet" href="assets/css/b   ootstrap.min.css">
        ...
        <section class="slider-area hero-overly">
            <div class="slider-active">
                ...
                <div class="single-slider slider-height d-flex align-items-center">
                    <div class="container">
                        <div class="row">
                            <div style="margin-left: 40px; margin-top: 30%;">
                                <div class="hero__caption">
                                    ...
                                    <a href="services.php" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">Explore Services</a>
                                </div>
                            </div>
                        </div>
                    </div>          
